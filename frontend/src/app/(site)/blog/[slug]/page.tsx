...
export default async function PostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <>
      ...
      <Container className="py-12 max-w-4xl relative">
        {/* Ambient background glow */}
        <div className="ambient-glow -top-16 -left-16 opacity-60" />
        
        {/* Article header metadata */}
        <ScrollReveal>
          <div className="mb-6 flex flex-wrap items-center gap-x-4 gap-y-2 border-b border-border/40 pb-4 text-xs text-muted-foreground font-mono relative z-10">
        ...
        {image && (
          <ScrollReveal delay={0.05}>
            <div className="relative aspect-video md:aspect-[21/9] max-h-[400px] w-full overflow-hidden rounded-lg border border-border shadow-md mb-8 relative z-10">
              <Image
                src={image}
                alt={post.title}
                fill
        ...
        <ScrollReveal delay={0.1}>
          <div className="mx-auto max-w-3xl glass-card p-6 md:p-8 relative z-10">
            ...
            {/* Author Box */}
            <div className="mt-12 glass-card border-primary/10 bg-card/40 p-6 flex flex-col sm:flex-row items-center gap-4">
