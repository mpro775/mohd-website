...
export const categoriesData = [
  {
    ...
    description:
      'مقالات حول هندسة البرمجيات، الأنماط المعمارية، أفضل الممارسات، وتصميم الأنظمة.',
    isActive: true,
  },
  {
    name: 'تطوير الويب',
    ...
    description:
      'محتوى متخصص في تطوير تطبيقات الويب الحديثة وتقنيات الواجهة الأمامية والخلفية.',
    isActive: true,
  },
  {
    name: 'منصات SaaS',
  ...
  },
  {
    ...
    description:
      'مقالات وأدلة عملية حول الذكاء الاصطناعي والمساعدات الذكية والنماذج اللغوية.',
    isActive: true,
  },
  {
    ...
    description:
      'من الفكرة إلى الإطلاق: استراتيجيات بناء المنتجات الرقمية الناجحة.',
    isActive: true,
  },
  {
    ...
    slug: 'startups',
    description:
      'محتوى حول ريادة الأعمال التقنية وتأسيس الشركات الناشئة وإدارة النمو.',
    isActive: true,
  },
  {
    name: 'دراسات حالة',
    slug: 'case-studies',
    description:
      'تحليل وتوثيق المشاريع الحقيقية والتحديات التقنية والحلول المستخدمة.',
    isActive: true,
  },
  {
    name: 'المسار المهني',
  ...
  },
  {
    ...
    slug: 'thoughts',
    description:
      'وجهات نظر شخصية حول التقنية والمستقبل والابتكار وريادة الأعمال.',
    isActive: true,
  },
];
...
export async function seedBlogCategories(categoryModel: Model<Category>) {
  for (const data of categoriesData) {
    ...
    if (existing) {
      console.log(
        `Blog Category with slug "${data.slug}" already exists, updating...`,
      );
