...
import { Technology, TechnologySchema } from '../../modules/technologies/schemas/technology.schema';
...
async function bootstrap() {
  ...
  try {
    ...
    const technologyModel = mongoose.model<Technology>(Technology.name, TechnologySchema);
    ...
    const blogCategoryModel = mongoose.model<Category>(Category.name, CategorySchema);
