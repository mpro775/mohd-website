...
export const PROJECT_CATEGORIES_METADATA = [
  {
    value: ProjectCategory.WEB_APP,
    labelAr: 'تطبيق ويب',
    labelEn: 'Web Application',
  },
  {
    value: ProjectCategory.MOBILE_APP,
    labelAr: 'تطبيق جوال',
  ...
  },
  {
    ...
    labelAr: 'لوحة تحكم',
    labelEn: 'Dashboard / Portal',
  },
  {
    value: ProjectCategory.API_BACKEND,
    labelAr: 'واجهة برمجية / باك إند',
    labelEn: 'API / Backend',
  },
  {
    value: ProjectCategory.SAAS,
    labelAr: 'برمجيات كخدمة (SaaS)',
    labelEn: 'Software as a Service (SaaS)',
  },
  {
    value: ProjectCategory.AI,
    labelAr: 'ذكاء اصطناعي',
    labelEn: 'Artificial Intelligence',
  },
  {
    value: ProjectCategory.AUTOMATION,
    labelAr: 'أتمتة عمليات',
    labelEn: 'Automation / Scripting',
  },
  {
    value: ProjectCategory.UI_UX,
    labelAr: 'تصميم تجربة وواجهة المستخدم',
